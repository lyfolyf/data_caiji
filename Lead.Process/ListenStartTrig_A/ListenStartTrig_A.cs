...
{
    public class ListenStartTrig_A : IProcess
    {
        private ProxyData _ProxyData = null;    //数据集
        private readonly StationEnum currentStation = StationEnum.S1_A;
        ...
        public ListenStartTrig_A(ProxyData Data)
        {
            _ProxyData = Data;
        ...
        public void Start()
        {
            ...
            _State = ProcessState.ProcessRunning;
            Logger.Info("进入ListenStartTrig_A循环");
        }
        ...
        public void Terminate()
        {
            ...
            Logger.Info("退出ListenStartTrig_A循环");
        }
